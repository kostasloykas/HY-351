...
@WebServlet(name = "GetNurse", urlPatterns = {"/GetNurse"})
public class GetNurse extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Nurse check_nur_email = nur.databaseNurseToJSON_email(email);
                        
            if (check_uname == null && check_email == null && check_doc_uname == null && check_doc_email == null && check_nur_uname == null && check_nur_email == null) {
                response.setStatus(200);
            } else {
                if (check_uname != null || check_doc_uname != null || check_nur_uname != null) {
                    response.setStatus(403);
                } else if (check_email != null || check_doc_email != null || check_nur_email != null) {
